 ...
 * to the root directory. Connect the wiper of a potentiometer to analog pin 0 and the
 * other two pins of the pot to GND and a pin held HIGH (+5V for a 5V based Arduino.)
 *
